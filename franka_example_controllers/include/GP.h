...
public:
  ...
  void SetTraining(const Mat<REAL>& X, const Row<REAL> &y, const Mat<REAL>& U);
  void AddTraining(const Mat<REAL>& X, const Row<REAL> &y, const Mat<REAL>& utr);
  void Predict(const Mat<REAL>& Xs, REAL& mu, REAL& gmu, REAL& gg2mu);
  void Predict(const Mat<REAL>& Xs, Row<REAL>& mu, Row<REAL>& var, Row<REAL>& gmu, Row<REAL>& gg2mu);
  void Predict(const Col<REAL>& Xs, const Mat<REAL>& utr, REAL& mu, REAL& gmu, REAL& gg2mu);
  void Predict(const Col<REAL>& Xs, const Mat<REAL>& utr, REAL& mu, REAL& var, REAL& gmu, REAL& gg2mu);
...
protected:
  ...
  void MatrixMap(Mat<REAL> &matrix, const Mat<REAL> &a, const Mat<REAL> &b, const Row<REAL>& U);
};
