...
namespace franka_example_controllers
{
  ...
  bool CartesianVelocityExampleController::init(hardware_interface::RobotHW *robot_hardware, ros::NodeHandle &node_handle)
  {
    ...
    {
      ROS_ERROR("CartesianVelocityExampleController: Could not get Cartesian velocity interface from "
                "hardware");
      return false;
    }
    try
  ...
  {
    std::cout << "--------------start:CartesianVelocityExampleController_2.22--------------" << std::endl;
